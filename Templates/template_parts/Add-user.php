<div class="Add-User-Page" style="color:white;">
    ...
    <section class="d-flex flex-xl-row flex-column">
        ...
        <section class="add-user"> 
            ...
            <div class="border-right-0 border-left-0 border-bottom-0 border border-primary">
                ...
                <div class="mb-3">
                     <label for="user-name" class="form-label">User Email ID</label>
                     <input class="form-control form-control" type="email" placeholder=" User Email ID" id="user-name"  name="suser" required="">
                     ...
                     <input class="form-control " type="password" placeholder="PassWord" id="pass-word"  name="spass" required="">
        ...
        <section class="project-list ml-3"> 
            ...
            <h3 class="recent-title-h3" >User List</h3>
...
<tbody class="user-list-data" >

<?php  
if($admin_check == 0){
    $sql2 = "SELECT * from  auth where reg_no = $registration and username = '$admin_user' AND  admin_check = 0";
}
else if($admin_check == 10){
    $sql2 = "SELECT * from  auth where admin_check = 0";
}
else{
$sql2 = "SELECT * from  auth where admin_check = 0 and admin_user = '$admin_user'";
}
